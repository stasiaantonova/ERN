...
if ss -tulpen | awk '{print $5}' | grep -q ":10356$" ; then
        echo -e "\e[31mInstallation is not possible, port 10356 already in use.\e[39m"
        exit
else
        echo ""
fi
...
NAMADA_CHAIN_ID="public-testnet-6.0.a0266444b06"
